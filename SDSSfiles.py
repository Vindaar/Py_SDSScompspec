...
#    print spec.PCA_qual
    ...
    # correct ivar values
    spec.flux_error = sqrt(1/TableHDU1['ivar'][:])/TableHDU1['NOISE_CORR'][:]
...
def get_array_from_ind_exposures(spec, settings, return_array = 0):
    # this function reads additional information from the spec FITS files
    # for the flux calibration. It mainly reads weather data from the 
